...
urlpatterns = [
    ...
    path('client/', include([
        path('list/', views.ClientsListView.as_view(), name='client_list'),
        path('add/', views.ClientsAddView.as_view(), name='client_add'),
        path('<int:pk>/detail/', views.ClientsDetailView.as_view(), name='client_detail'),
    ...
    path('project/', include([
        path('list/', views.ProjectsListView.as_view(), name='project_list'),
        path('add/', views.ProjectsAddView.as_view(), name='project_add'),
        path('<int:pk>/detail/', views.ProjectsDetailView.as_view(), name='project_detail'),
        path('<int:pk>/update/', views.ProjectsUpdateView.as_view(), name='project_update'),
        path('<int:pk>/delete/', views.ProjectsDeleteView.as_view(), name='project_delete'),
    ])),

    path('interplay/', include([
        path('list/', views.InterplaysListView.as_view(), name='interplay_list'),
        path('add/', views.InterplaysAddView.as_view(), name='interplay_add'),
        path('<int:pk>/detail/', views.InterplaysDetailView.as_view(), name='interplay_detail'),
        path('<int:pk>/update/', views.InterplaysUpdateView.as_view(), name='interplay_update'),
        path('<int:pk>/delete/', views.InterplaysDeleteView.as_view(), name='interplay_delete'),
    ])),

    path('tag/', include([
        path('list/', views.TagsListView.as_view(), name='tag_list'),
        path('add/', views.TagAddView.as_view(), name='tag_add'),
        path('<int:pk>/detail/', views.TagsDetailView.as_view(), name='tag_detail'),
        path('<int:pk>/update/', views.TagUpdateView.as_view(), name='tag_update'),
        path('<int:pk>/delete/', views.TagsDeleteView.as_view(), name='tag_delete'),
    ])),
]
